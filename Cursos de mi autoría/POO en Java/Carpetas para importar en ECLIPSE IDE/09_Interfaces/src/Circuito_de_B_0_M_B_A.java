public class Circuito_de_B_0_M_B_A extends Circuito implements Arduino, MOTOR_DC{
	...
	public boolean ARD_OFF(){
		// Dada la naturaleza de este objeto, no se supone que podamos alcanzar este fragmento de código, aunque la interface lo pide :)
		return true;
	}
	...
	public boolean MOTOR_ON(double power, short pin){ // !!!!
		// supongamos que en alguna parte de esta implementación, usamos los valores que acabamos de recibir xdxdxdxd
	...
	//Implemento una sola vez, un método que aparece en las interfaces de Arduino y de MOTOR_DC al mismo tiempo, y con esa sola vez basta
