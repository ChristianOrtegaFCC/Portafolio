...
;Juan Sabino Torres Mariaca
;Samanta Sanchez Torres
;Jessica Anahi Rodriguez Sosa
...
MOV DL, AH
    ...
    CALL IMP2DIG
    ADD CNT,1    ; incrementamos nuestro contador de validacion de escritura...
...
CMP CNT, 2      ; verifica lo que se debe escribir
JE DOSPUNTOS
CMP CNT,4
JE IMPENTER 
    ...
    MOV DL,3AH
    MOV AH,02H
    INT 21H     ; esta parte escribe dos puntos...
    JMP SIGUE
...
CMP SI,88; 64 = 16 VCTRS,  ==> 1 VCTR = C/4 
JE TERMINA
...
IMP2DIG PROC NEAR
    ...
    INT 21H    
    JMP VAL ; saltamos a la siguiente parte del proceso, el digito 2
    ...
    INT 21H    
    JMP VAL2           ; saltamos a la siguiente parte del proceso, el retorno
