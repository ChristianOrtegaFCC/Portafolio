...
{
  La manera en la que se manejarán los datos será la siguiente:
  ...
  y funciona igual para los tubos (también son prismas pero delgaditos y estirados)
  jajajaj
}
...
if (opendialog1.Execute) then begin
  ...
  for I := 1 to 41 do Button8Click(Sender);
...
if(tipo_tubos[j] = True) then Image1.Canvas.Pen.Color := RGB(203,109,81) else Image1.Canvas.Pen.Color := clblack;
